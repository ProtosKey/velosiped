...
## 1.1.0 - 2026-04-29
#### Features
- (**drop**) add command to untrack files from the index - (c537585) - Prokhor
- (**reset**) implement --hard-style reset to a target commit - (eec8eb9) - Prokhor
- commit command mark missing files as deleted before commit - (f8e1cd6) - Prokhor
- added deleted files status output, iterator fixed, add function for path from you - (e9b5d98) - Rinat
#### Bug Fixes
- separator - - - in changelog for cog - (0c9e991) - Prokhor
- infinite loop while hash identical of parent and child - (ea86311) - Prokhor
- keep objects append-only, stop unlinking old blobs - (d381e0f) - Prokhor
#### Documentation
- document reset and drop, mark cycle complete - (937adf8) - Prokhor
#### Tests
- cover reset round-trip and drop semantics - (ae34360) - Prokhor
#### Continuous Integration
- add cJSON installation step in CI workflow - (f54513a) - Oriptal
#### Miscellaneous Chores
- add simple CI workflow for testing with CMake - (afa094d) - Oriptal
- add issue templates - (9d7bee1) - Prokhor
- update some md files with project desc - (e786110) - Prokhor
- add Contributor Covenant Code of Conduct - (d84a16e) - Oriptal
- add MIT License to the project - (334ac63) - Oriptal
